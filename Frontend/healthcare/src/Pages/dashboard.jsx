...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, PieChart, Pie, Cell } from 'recharts'; // Import Recharts components
...
const ChartsRow = styled.div`
  display: flex;
  justify-content: space-between; /* Space out the bar and pie charts */
      ...
      <MainSection>
        ...
        <MainContent>
          ...
          <ChartsRow>
            {/* Bar Chart Section */}
            <ChartSection>
              <Typography variant="h5" gutterBottom style={{ marginBottom: '20px', fontFamily: 'cursive', fontWeight: 'bold', color: 'purple', textAlign: 'center' }}>
                Category Counts
              </Typography>
              <BarChartContainer>
